    ...
    <section id="home" className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div className="text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-6xl font-outfit font-bold text-porta-heading leading-tight mb-6 drop-shadow-sm flex flex-wrap justify-center lg:justify-start gap-x-3 gap-y-1">
            {["Cuidamos", "tu", "sonrisa", "como", "si", "fuera", "la"].map((word, i) => (
              <span
                key={i}
                className="animate-fall-in inline-block"
            ...
            <span
              className="text-porta animate-fall-in inline-block"
