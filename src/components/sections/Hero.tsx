      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in-up delay-200">
            <a
              href={`https://wa.me/${CLINIC_INFO.whatsapp}?text=Hola,%20le%20escribo%20desde%20su%20página%20web.%20Quisiera%20más%20información%20sobre%20sus%20servicios.`}
            ...
            <a
              href="#services"
              className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-2xl font-bold transition-all shadow-sm flex items-center justify-center backdrop-blur-sm bg-white/80"
            >
              Ver Servicios
            </a>
          </div>
